...
/**
 * This base class makes sure that a binding between extension point
 * and extension exists. This is important for the plugin that provides
 * the EP and consumes extensions, not for the one that provides an
 * extension.
 */
